<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服饰表名" prop="tablename">
          <el-input v-model="ruleForm.tablename" 
              placeholder="服饰表名" clearable  :readonly="ro.tablename"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服饰表名" prop="tablename">
              <el-input v-model="ruleForm.tablename" 
                placeholder="服饰表名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服饰id" prop="goodid">
          <el-input v-model="ruleForm.goodid" 
              placeholder="服饰id" clearable  :readonly="ro.goodid"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服饰id" prop="goodid">
              <el-input v-model="ruleForm.goodid" 
                placeholder="服饰id" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服饰名称" prop="goodname">
          <el-input v-model="ruleForm.goodname" 
              placeholder="服饰名称" clearable  :readonly="ro.goodname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服饰名称" prop="goodname">
              <el-input v-model="ruleForm.goodname" 
                placeholder="服饰名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  data() {
	...
	discountprice : false,
      ...
      rules: {
          ...
          goodid: [
                { required: true, message: '服饰id不能为空', trigger: 'blur' },
          ],
          goodname: [
          ],
          picture: [
